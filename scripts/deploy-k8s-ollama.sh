...
echo "Kubernetes Manifests (Ollama)"
echo "========================================"
...
# Ollama deployment requires AI to be enabled.
...
echo "Applying Ollama AI Chat Service..."

kubectl apply -f k8s/ai-chat-service/configmap-ollama.yaml
kubectl apply -f k8s/ai-chat-service/deployment-ollama.yaml
